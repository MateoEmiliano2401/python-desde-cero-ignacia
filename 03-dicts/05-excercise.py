search = input("¿Que lenguajes quieres conocer?")
...
# Crear un programa que muestre el valor de la llave solicitada si existe en el diccionario, y que diga que no esta si la llave no está en el diccionario



if search in lenguajes:
    print("Si está en lenguaje", search)
